...
//        binding.search = viewModel
        ...
        adapter = ArrayAdapter<City>(this, android.R.layout.select_dialog_item, cities)
            ...
            object : TextWatcher{
                override fun afterTextChanged(s: Editable?) {
                    if(s.toString().length > 3){
                        viewModel.searchCity(idAutoCompleteSearchCity.text.toString(), apiKey)
                    }
                }
